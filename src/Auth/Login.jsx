...
//         <div className="w-1/2 p-12 flex flex-col justify-center rounded-lg">
...
//           <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Login To Continue</h2>
...
//                 className="w-full px-4 py-3 mt-2 border rounded-md focus:ring focus:ring-blue-200 focus:outline-none"
//                 required
//               />
//             </div>
...
//             <button
//               type="submit"
//               className="w-full px-4 py-3 text-white bg-[#2E5870] rounded-md hover:bg-blue-900 focus:outline-none focus:ring focus:ring-blue-200"
//             >
//               LOGIN
//             </button>
//           </form>
